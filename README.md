...
### Gene-targeted mode
For organisms where whole-genome specificity is insufficient (e.g. Gardnerella, Corynebacterium).
...
Force specific strains into the exclusion set regardless of size cap:
```bash
python run_pipeline.py \
    --organism "Gardnerella vaginalis" \
    --extra-exclusion CP180513.1 CP019058.1 \
    --email your@email.com \
    --api-key YOUR_NCBI_API_KEY
```
